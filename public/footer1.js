...
Vue.component('footer1', {
	...
	template: `
	<div class="footer-dark firstfooter" style="background-color:#202020;min-width:100%;">
        <footer>
            <div class="container" style="min-width:90%;width:90%;padding-right:8%;margin-right:-5%;">
                <div class="row d-inline-block" style="min-width:100%;">

					<div class="col-sm-12 col-md-8 col-lg-2 d-inline-block item text text2 " >
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-2 d-inline-block item colfooter" id="one">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-2 d-inline-block item colfooter"  id="two">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-2 d-inline-block item colfooter" id="three">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-2 d-inline-block item colfooter" id="four" >
