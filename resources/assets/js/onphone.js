            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form class="form-inline" method="post">
                        <div class="form-group"><input class="form-control" type="phonenumber" name="number" placeholder="مثلا 91220530**"></div>
                        <div class="form-group "><button  type="submit">دریافت لینک از طریق SMS </button></div>
                    </form>
					<p class="afterform">
